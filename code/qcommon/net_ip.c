...
/* It seems that optimizations are causing connecting to a server to
 * time out */
#ifdef __amigaos4__
...
#ifdef __amigaos4__
#define getaddrinfo getaddrinfo_gai
#define freeaddrinfo freeaddrinfo_gai
#endif
...
#endif /* defined (__amigaos4) && defined ( __NEWLIB) */
